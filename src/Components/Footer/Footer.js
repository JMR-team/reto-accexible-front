    ...
    <>
      <div className="footer">
        <div className="containerFooter">
          <div className="box">
            <figure style={{ margin: 0 }}>
              <img src={AccexibleLogo} alt="logo AcceXible" />
            </figure>
          </div>
          <div className="box">
            <h2>Barcelona</h2>
          ...
          <div className="box">
            ...
            <div className="social">
              <a
                href="https://twitter.com/accexible"
                target="_blank"
                rel="noreferrer"
              >
              ...
              <a
                href="https://www.linkedin.com/company/accexible/?originalSubdomain=es"
                target="_blank"
                rel="noreferrer"
              >
        ...
        <div className="containerInfoFooter">
          <small>
            &copy; 2021 <b>Code4Jobs</b> - Reto De Empresa AcceXible.
          </small>
        </div>
      </div>
    </>
